...
amass enum -d $domain -r 1.1.1.1 # -config ~/config.ini     ### This file has been lost in old VM need to recreate https://github.com/OWASP/Amass/blob/master/examples/config.ini
